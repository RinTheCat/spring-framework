...
insert into users (username, password) values ('user1', 'qwerty1');
insert into users (username, password) values ('user2', 'qwerty2');
insert into users (username, password) values ('user3', 'qwerty3');
